...
typedef MultiBaseFunction = void Function(
    Map<String, BaseBloc>? blocs, Set<StreamSubscription> subscriptions);
...
class MultiBaseProvider extends StatefulWidget {
  ...
  MultiBaseProvider._copy({
    ...
    required MultiBaseInherited inherited,
          ...
          .._blocs = _instances[key]!._inherited._blocs
  ...
  static PublishSubject<BaseException?>?
      exception<R extends MultiBaseInherited>(BuildContext context) =>
